...
const translations = {
  es: {
    ...
    'monitoring.satelliteAndWeather': 'Datos satelitales y clima',
    'monitoring.lastSatellitePass': 'Última pasada satelital',
    'monitoring.tapToView': 'Toca para ver datos satelitales y meteorológicos',
    'monitoring.notConnected': 'Monitoreo satelital no conectado',
    'monitoring.connectHint': 'Activa Agromonitoring para esta parcela.',
    'monitoring.satelliteUnavailable': 'Datos satelitales no disponibles aún para esta parcela.',
    'monitoring.connectError': 'No se pudo conectar el monitoreo. Revisa las coordenadas de la parcela.',
    'monitoring.tabVegetation': 'Vegetación',
    'monitoring.tabWeather': 'Clima',
    'monitoring.tabSoil': 'Suelo',
    'impact.title': 'Impacto Ambiental',
    'impact.co2Captured': 'CO₂ capturado',
    'impact.activeHectares': 'Hectáreas restauradas',
    'impact.ndviTrend': 'Tendencia NDVI 90d',
    'impact.daysMonitored': 'Días monitoreados',
    'impact.lastPass': 'Última pasada',
    'impact.noSatellitePass': 'Sin pasada reciente',
    'impact.clouds': 'nubes',
    ...
    'timeslider.noFrames': 'Aún no hay imágenes satelitales históricas para esta parcela.',
    'map.satellite': 'Satélite',
    'map.hybrid': 'Híbrido',
    'map.street': 'Mapa',
    'map.fullscreen': 'Pantalla completa',
    'map.exitFullscreen': 'Salir de pantalla completa',
    'map.loadingOnScroll': 'Mapa se carga al hacer scroll…',
  },
  en: {
    // Navigation
    'nav.dashboard': 'Dashboard',
    ...
    'monitoring.satelliteAndWeather': 'Satellite & weather data',
    'monitoring.lastSatellitePass': 'Last satellite pass',
    'monitoring.tapToView': 'Tap to view satellite & weather data',
    'monitoring.notConnected': 'Satellite monitoring not connected',
    'monitoring.connectHint': 'Enable Agromonitoring for this plot.',
    'monitoring.satelliteUnavailable': 'Satellite data not yet available for this plot.',
    'monitoring.connectError': 'Could not connect monitoring. Check plot coordinates.',
    'monitoring.tabVegetation': 'Vegetation',
    'monitoring.tabWeather': 'Weather',
    'monitoring.tabSoil': 'Soil',
    'impact.title': 'Environmental Impact',
    'impact.co2Captured': 'CO₂ captured',
    'impact.activeHectares': 'Hectares restored',
    'impact.ndviTrend': 'NDVI trend 90d',
    'impact.daysMonitored': 'Days monitored',
    'impact.lastPass': 'Last pass',
    'impact.noSatellitePass': 'No recent pass',
    'impact.clouds': 'clouds',
    ...
    'timeslider.noFrames': 'No historical satellite imagery yet for this plot.',
    'map.satellite': 'Satellite',
    'map.hybrid': 'Hybrid',
    'map.street': 'Map',
    'map.fullscreen': 'Fullscreen',
    'map.exitFullscreen': 'Exit fullscreen',
    'map.loadingOnScroll': 'Map loads on scroll…',
  }
};
